...
(inicio padrão 0, passo de 1 em 1)
...
#OBS: valor_de_parada inclusive (inicio especificado pelo usuário, passo especificado pelo usuário)
print('\n')
...
#FORMA 4: (INVERSA) semelhante a forma 3 mas invertendo a ordem das instruções
